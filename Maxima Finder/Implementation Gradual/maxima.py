...
def cctv_placement(crime_matrix, cctv_number, distance=0.05, cctv_effectivity=0.078, effectivity=0):
  ...
  indices = np.argpartition(difference_crime_matrix.flatten(), cctv_number)[:cctv_number]
  #row_indices, col_indices = np.unravel_index(indices, difference_crime_matrix.shape)
