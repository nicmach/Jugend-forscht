...
def calculate_difference_matrix_update(crime_difference_matrix, coordinates_changed, coordinates_last_changed, distance, cctv_effectivity=0.078, effectivity=0):
  number_of_fields = impacted_fields(distance, cctv_effectivity)
  num_rows, num_cols = crime_difference_matrix.shape
...
def cctv_placement(crime_matrix, cctv_number, distance=0.05, cctv_effectivity=0.078, effectivity=0.2):
  ...
  while i < cctv_number:
    if i==0: final_difference_crime_matrix = calculate_difference_matrix(final_crime_matrix, coordinates_changed, distance, cctv_effectivity, effectivity)
    else: final_difference_crime_matrix = calculate_difference_matrix_update(final_difference_crime_matrix, coordinates_changed, coordinates_last_changed, distance, cctv_effectivity=0.078, effectivity=0)
